...
const TireBrands = () => {
  const columns = [
    ...
    actionsBtnConfig,
    { dataField: "BrandCode", displayName: "Brand Code" },
    { dataField: "BrandName", displayName: "Brand Name" },
    { dataField: "PartCode", displayName: "Part Code" },
    { dataField: "Quality", formElement: 'select', hardSelectOptions:[null, 'Big 3', '2nd Tier', '3rd Tier', '4th Tier'] }
  ];

  return (
    <div className="">
      <IventoryBootstrapTable endpoint="TireBrands" columns={columns} />
    </div>
  );
};
